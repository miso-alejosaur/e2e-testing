Feature: Escenario 13: Crear Un Nuevo Post - Verificar que no este en la Lista de Drafts - Despublicar Post - Verificar Que Este En El Drafts

    Feature Crear un post y que este sea visible para el usuario
   
    Scenario: Crear un nuevo post y publicar post (vista de administrador)
