Feature: Escenario 9: Crear Un Nuevo Tag - Crear Post Con Tag y Filtrar Segun su Tag como usuario
    ...
    Scenario: Crear un segundo post
        Given Ingresa a la pagina de inicio de sesion
            When Ingresa el nombre de usuario "test@test.tt" e ingresa la contraseña "1234567890a."
        Then Iniciar Sesion Exitoso

            When Hace click en el boton de new post
            And Ingresa el titulo del post 'New-Post-2'
            And Ingresa la descripcion del post 'Description new post 2'
            And Hacer click en el boton menu del post
            And Selecionar el 'New-Tag'
            And Hace click en el boton de create post
            And Hace click en el boton de publish post
    ...
    Scenario: Eliminar el segundo post
        Given Ingresa a la pagina de inicio de sesion
            When Ingresa el nombre de usuario "test@test.tt" e ingresa la contraseña "1234567890a."
        Then Iniciar Sesion Exitoso
