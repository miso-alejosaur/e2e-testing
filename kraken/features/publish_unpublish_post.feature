...
Scenario: Como autor creo un post y lo elimino
    ...
    And I send a signal to user 2 containing "unpublishing"
    And I wait for 2 seconds
...
Scenario: Como usuario verifico que el post esté creado y luego eliminado
    ...
    And I wait for a signal containing "unpublishing" for 30 seconds
    And I wait for a signal containing "post hidden" for 30 seconds
